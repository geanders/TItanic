...
------------- | ------------- | ---- | -------| ---------| ---
**Positives** |  |  | | |
Natural fit with categorical predictors | + | - | + | 0 | +
...
Easy to do >2 outcome classes | 0 | - | - | - | 0
Works okay with missing values | - | - | - | 0 | +
Good for determining class probabilities | + | + | +  | 0 | +
Works okay with smaller training datasets | + | + | + | 0 | 0
Works with more predictors than observations | 0 | 0  | - | + | - 
Does okay handling irrelevant predictors | 0  | 0 | + | 0 | -
Does okay handling lots of predictors | - | - | - | 0 | -
Works okay with many-level categorical predictors | - | - | + | 0 | -
Easy to update with new training data | 0 | - | + | + | 0
Does okay if training data is not random sample | - | - | - | - | -
**Negatives** |  |  | | |
Assumes independence in predictors | 0 | 0 | + | - | - 
Assumes distribution for continuous predictors | + | + | + | 0 | 0
